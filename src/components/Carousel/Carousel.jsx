      ...
      <div className={styles.container} ref={containerRef}>
        <div className={styles.item}>
          ...
          <div className={styles.textContainer}>
            ...
            <p className={styles.description}>이제 막 도착한 패션 청바지를 구경해 보세요.</p>
        ...
        <div className={styles.item}>
          ...
          <div className={styles.textContainer}>
            ...
            <p className={styles.description}>다양한 디지털 상품을 둘러보세요.</p>
        ...
        <div className={styles.item}>
          ...
          <div className={styles.textContainer}>
            ...
            <p className={styles.description}>농장 직배송으로 더욱 신선한 식료품을 만나보세요.</p>
